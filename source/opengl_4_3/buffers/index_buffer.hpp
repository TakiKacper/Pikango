...
void pikango::cmd::write_buffer(index_buffer_handle target, size_t data_size_bytes, void* data)
{
    write_buffer_memory_generic<index_buffer_handle>(target, data_size_bytes, data);
}

void pikango::cmd::write_buffer_region(index_buffer_handle target, size_t data_size_bytes, void* data, size_t data_offset_bytes)
{
